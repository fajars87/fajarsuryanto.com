...
{!! Form::open(array('route' => config('quickadmin.route').'.hobby.store', 'id' => 'form-with-validation', 'class' => 'form-horizontal')) !!}
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {!! Form::text('detail', old('detail'), array('class'=>'form-control')) !!}
