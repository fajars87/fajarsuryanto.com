...
{!! Form::open(array('route' => config('quickadmin.route').'.experience.store', 'id' => 'form-with-validation', 'class' => 'form-horizontal')) !!}
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {!! Form::text('project', old('project'), array('class'=>'form-control')) !!}
