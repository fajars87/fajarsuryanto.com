...
{!! Form::open(array('route' => config('quickadmin.route').'.skillpro.store', 'id' => 'form-with-validation', 'class' => 'form-horizontal')) !!}
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {!! Form::text('skill_range', old('skill_range'), array('class'=>'form-control')) !!}
