...
{!! Form::open(array('route' => config('quickadmin.route').'.education.store', 'id' => 'form-with-validation', 'class' => 'form-horizontal')) !!}
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {!! Form::text('period', old('period'), array('class'=>'form-control')) !!}
    ...
    <div class="col-sm-10">
        {!! Form::textarea('note', old('note'), array('class'=>'form-control ckeditor')) !!}
